...
- (NSMenu *)createMenuBar {
  ...
  // App Menu
  NSMenuItem *pAppMenuItem = [[NSMenuItem alloc] initWithTitle:@"Appname"
                                                        action:nil
                                                 keyEquivalent:@""];
  ...
  NSMenuItem *pAppQuitItem =
      [[NSMenuItem alloc] initWithTitle:quitItemName
  ...
  // Window Menu
  NSMenuItem *pWindowMenuItem = [[NSMenuItem alloc] initWithTitle:@"Window"
                                                           action:nil
                                                    keyEquivalent:@""];
  NSMenu *pWindowMenu = [[NSMenu alloc] initWithTitle:@"Window"];
  NSMenuItem *pCloseWindowItem =
...
- (void)applicationDidFinishLaunching:(NSNotification *)notification {
  ...
  _pView = [[MetalKitView alloc] initWithFrame:frame device:_pDevice];
  ...
  _pView.keyEventsDelegate = _pViewDelegate;
