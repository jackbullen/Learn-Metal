...
APP_00WINDOW_OBJECTS=learn-metal-cpp/00-window/00-window.o
APP_01PRIMITIVE_OBJECTS=learn-metal-cpp/01-primitive/01-primitive.o
APP_02ARGBUFFERS_OBJECTS=learn-metal-cpp/02-argbuffers/02-argbuffers.o
APP_03ANIMATION_OBJECTS=learn-metal-cpp/03-animation/03-animation.o
APP_04INSTANCING_OBJECTS=learn-metal-cpp/04-instancing/04-instancing.o
APP_05PERSPECTIVE_OBJECTS=learn-metal-cpp/05-perspective/05-perspective.o
APP_06LIGHTING_OBJECTS=learn-metal-cpp/06-lighting/06-lighting.o
APP_07TEXTURING_OBJECTS=learn-metal-cpp/07-texturing/07-texturing.o
APP_08COMPUTE_OBJECTS=learn-metal-cpp/08-compute/08-compute.o
APP_09COMPUTETORENDER_OBJECTS=learn-metal-cpp/09-compute-to-render/09-compute-to-render.o
APP_10FRAMEDEBUGGING_OBJECTS=learn-metal-cpp/10-frame-debugging/10-frame-debugging.o
...
# project-less capture requires an Info.plist. Here it is embedded directly into the binary
	$(CC) $(CFLAGS) $(LDFLAGS) -sectcreate __TEXT __info_plist ./learn-metal-cpp/10-frame-debugging/Info.plist $(APP_10FRAMEDEBUGGING_OBJECTS) -o $@
