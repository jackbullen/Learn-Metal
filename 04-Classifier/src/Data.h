...
@private
  ...
  NSString *_label;
  float *_biasPointer, *_weightPointer, *_biasMomentumPointer,
      *_biasVelocityPointer, *_weightVelocityPointer, *_weightMomentumPointer;
  ...
  MPSVector *_weightMomentumVector, *_biasMomentumVector,
      *_weightVelocityVector, *_biasVelocityVector, *_weightVector,
      *_biasVector;
